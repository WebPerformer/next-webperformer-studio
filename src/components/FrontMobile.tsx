  ...
  return (
    <div>
      ...
      <div className="relative flex items-center justify-center gap-16 my-32 text-xxl">
        <Image src={design} alt="" className="w-1/3 rounded-2xl" />
        <TbArrowMoveRight className="text-blue" />
        <Image src={code} alt="" className="w-1/3 rounded-2xl" />
        <div className="absolute w-full h-screen bg-gradient-to-r from-pink to-blue rounded-full blur-3xl opacity-10 -z-10" />
      </div>
    </div>
  )
}
